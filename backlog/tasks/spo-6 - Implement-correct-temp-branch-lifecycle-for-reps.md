...
spotme_exercise now branches off the current branch (not main). On done/solve/skip the event handler switches back to the original branch and deletes the temp spotme/<unit> branch. Uncommitted work carries over naturally; no stash needed.
